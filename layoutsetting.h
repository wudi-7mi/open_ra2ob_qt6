...
constexpr int PRODUCINGBLOCK_WS    = 59;
constexpr int PRODUCINGBLOCK_Y1    = 10;
constexpr int PRODUCINGBLOCK_Y2    = 70;
constexpr int PRODUCING_STATUS_Y   = 10;
constexpr int PRODUCING_NUMBER_Y   = 35;
constexpr int PRODUCING_PROGRESS_X = 4;
constexpr int PRODUCING_PROGRESS_Y = 44;
constexpr int PRODUCING_PROGRESS_W = 44;
constexpr int PRODUCING_PROGRESS_H = 5;
