...
constexpr int TOP_COUNTRY_X    = 280;
constexpr int TOP_COUNTRY_Y    = 30;
constexpr int TOP_COUNTRY_W    = 30;
constexpr int TOP_COUNTRY_H    = 20;
constexpr int TOP_I_X          = 320;
constexpr int TOP_I_WH         = 20;
constexpr int TOP_IBALANCE_Y   = 18;
constexpr int TOP_IPOWER_Y     = 44;
constexpr int TOP_BALANCE_X    = 346;
constexpr int TOP_BALANCE_Y    = 20;
constexpr int TOP_BALANCE_W    = 61;
constexpr int TOP_BALANCE_H    = 18;
constexpr int TOP_POWER_X      = 347;
constexpr int TOP_POWER_Y      = 47;
...
constexpr int PRODUCINGBLOCK_X     = 10;
constexpr int PRODUCINGBLOCK_Y     = 10;
constexpr int PRODUCINGBLOCK_SPACE = 5;
constexpr int PRODUCING_IMG_X      = 1;
constexpr int PRODUCING_IMG_Y      = 1;
constexpr int PRODUCING_IMG_W      = 60;
constexpr int PRODUCING_IMG_H      = 48;
constexpr int PRODUCING_STATUS_Y   = 10;
constexpr int PRODUCING_NUMBER_Y   = 39;
constexpr int PRODUCING_PROGRESS_W = 60;
constexpr int PRODUCING_PROGRESS_H = 7;
